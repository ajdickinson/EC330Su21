...
output:
  xaringan::moon_reader:
    css: ['default', 'metropolis', 'metropolis-fonts', 'my-css2.css']
...
.hi-slate[Name:] [Andrew Dickinson](https://github.com/ajdickinson) (call me Andrew)
...
- Third year Ph.D student
  ...
  - My research focus is in environmental economics and data science
...
.hi-slate[Not school:]
  ...
  - I enjoy spending time outside `r emo::ji("call me hand")`
      ...
      - running, camping, climbing, surfing, skiing, kayaking, cycling, etc.
...
.hi-slate[I want to discuss the following:]

--

.pull-left[
.hi-slate[(i).] Grading breakdowns
]
.pull-right[
.hi-slate[(ii).] Course Policies
]
...
# Syllabus: Grading
There are .hi-pink[500] points total.  .hi-slate[Your grade will be determined by:]
...
.hi-slate[Midterm:] End of week 2 (.pink[Thursday, July 28]<sup>.pink[†]</sup>)

.hi-slate[Final]: End of week 4 (.pink[Thursday, August 13])

.footnote[.hi[†] May change to Friday, July 29 if everyone is available]
...
--
  ...
  - Under .hi-slate[extraordinary circumstances], I will allow shifting all of the weight from the midterm on the final (67%)
  
    - Entirely by my discretion
    
    - Contact me before the exam via email
    
--

.hi-slate[Drop this course if you are unable to take the scheduled midterm]
...
- .hi-slate[Problem sets]: Occassional question from assigned reading

--

- .hi-slate[Exams]: Ocassional question from the book 

  - the questions will be pretty easy

--

- .hi-slate[Book Report]: Sunday following the last lecture (August 15)
...
# Wage Dispersion
```{r westcoast_income, include=F, message=F, cache=T, eval = FALSE}
