...
Why might profit increase ( $\Pi \uparrow$ ) initially as more firms .hi-pink[cluster]?

--

.hi-slate[Firms may mutually benefit from clustering due to:]

--

  - .hi-pink[(i).] Sharing intermediate inputs

  - .hi-pink[(ii).] Labor matching 

  - .hi-pink[(iii).] Knowledge spillovers

  - .hi-pink[(iv).] Labor pool sharing

--

<br>

.center[.hi-slate[Let's look at these in some more detail]]

---

# (i). Sharing inputs

Similar firms .hi-slate[share inputs] to benefit from economies of scale<sup>.hi[†]</sup>
...
.hi-slate[Exists a optimal cluster size that maximizes the benefits of sharing inputs]
...
.hi-slate[Knowledge spillovers:] Exchange of ideas across individuals within a space
...
.hi-slate[Urban settings:] Silicon Valley, Wall Street, etc.
...
.ul[.hi-slate[Definition]]: .hi[Agglomeration Economies]
