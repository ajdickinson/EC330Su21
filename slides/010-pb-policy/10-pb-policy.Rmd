...
Let the utility function be .hi[linear] and assume everyone is identical:
...
.hi[How can we use locational eq to "fix up" our last example?]
...
.hi[Thus far], we have assumed .hii[wages] and .hi-gold[rents] do not respond to these choices

--

This is a .hi[bad assumption] right?
...
- .qa[Q:] How many people live in each city? What are rents in each city? 
