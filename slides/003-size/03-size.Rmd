...
To understand the economic incentives behind cities, let's establish a simple economic model
...
.hi-slate[Let's make three assumptions that would eliminate any for households to geographically cluster]

--

  - .smallerer[Relaxing each assumption will give us .hi-pink[intuition] about the formation of cities]


---
# Backyard production model

.hi-slate[Model assumptions:]

--

.hi-pink[A01:] There exist no differences in the productivity of land nor labor

  - No comparative advantages
  
--
  
.hi-pink[A02:] .hi-slate[Constant Returns to Scale (CRS)] in .hi-orange[exchange] and .hi-orange[transportation]
...
.hi-pink[A03:] CRS in .hi-orange[Production]
...
These three assumptions would eliminate exchange and ensure each household is self sufficient:

.hi-pink[A01:] Equal productivity

.hi-pink[A02:] CRS in exchange and transportation

.hi-pink[A03:] CRS in production
...
So we explained .hi-slate[why] cities exist.. 

Can we explain why there might be more than one firm?

--

Where to start? .hi-slate[Axoim 5]

--

.center[.pink[Axiom 5: _Competition generates zero economic profit_]]
